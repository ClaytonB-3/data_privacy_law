...
def run_comprehensive_privacy_page():
    st.title("Comprehensive State Privacy Laws")

    user_question = st.text_input("Ask about Comprehensive Privacy Laws:")
...
def main():
    run_comprehensive_privacy_page()
