...
def run_federal_privacy_page():
    st.title("Federal Privacy Laws")

    user_question = st.text_input("Ask a question about Federal Privacy Laws:")
