...
class TestFAISSIndex(unittest.TestCase):
    ...
    def test_add_to_faiss_index_create_new(
    ...
    @patch("llm_manager.experimental_llm_manager.os.path.exists")
    @patch(
        "llm_manager.experimental_llm_manager.calculate_updated_chunk_ids",
    )
    def test_add_to_faiss_index_load_and_add_texts(
        self, mock_chunks, mock_exists, mock_embeddings, mock_faiss
    ):
        """
    ...
    def test_add_to_faiss_index_load_error(
        self, mock_chunks, mock_exists, mock_embeddings, mock_faiss
    ):
        """
