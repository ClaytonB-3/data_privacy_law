...
class StateFederalPageSubheaderTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.at = AppTest.from_file('./pages/4_EU_GDPR.py').run(timeout=10)
    ...
    def test_content_column_has_content(self):
        ...
        expected_snippet = "The General Data Protection Regulation (GDPR) is a comprehensive data protection law " \
